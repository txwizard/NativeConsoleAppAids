; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27027.1 
	...
	TTL	F:\Source_Code\Visual_Studio\Projects\NATIVE\DLL\NativeConsoleAppAids\NativeConssoleAppAids\FB_FindLineEndA.c
	THUMB
	.drectve
...
|__A1F58C60_fb_findlineenda@c| DCB 0x1
	EXPORT	|FB_FindLineEndA|
	EXPORT	|__JustMyCode_Default|
	IMPORT	|__CheckForDebuggerJustMyCode|
;	COMDAT .pdata
.pdata	SEGMENT
|$pdata1$FB_FindLineEndA| DCD imagerel |FB_FindLineEndA|
	DCD	imagerel |$unwind2$FB_FindLineEndA|
;	COMDAT .xdata
.xdata	SEGMENT
|$unwind2$FB_FindLineEndA| DCD 0x33200033
	DCD	0xa8fb02
	DCD	0x8802ff02
	DCD	0xff03ef00
;	COMDAT .pdata
...
; File f:\source_code\visual_studio\projects\native\dll\nativeconsoleappaids\nativeconssoleappaids\fb_findlineenda.c
;	COMDAT FB_FindLineEndA
.text$mn	SEGMENT

|FB_FindLineEndA| PROC
...
; 23   : {
	...
	sub         sp,sp,#8
|$M14|
	ldr         r0,|$LN11@FB_FindLin|		; =|__A1F58C60_fb_findlineenda@c|
...
|$LN10@FB_FindLin|
|$LN11@FB_FindLin|
	DCD         |__A1F58C60_fb_findlineenda@c|
|$M15|

	ENDP  ; |FB_FindLineEndA|
