; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27027.1 
	...
	TTL	F:\Source_Code\Visual_Studio\Projects\NATIVE\DLL\NativeConsoleAppAids\NativeConssoleAppAids\GetExeNameFromWindowsW.c
	THUMB
	.drectve
...
|__52D30485_getexenamefromwindowsw@c| DCB 0x1
	EXPORT	|GetExeHameFromWindowsW|
	EXPORT	|__JustMyCode_Default|
	IMPORT	|__imp_GetModuleFileNameW|
	IMPORT	|__CheckForDebuggerJustMyCode|
	.bss
|?rachrModuleNameBuffer@?1??GetExeHameFromWindowsW@@9@9| % 0x208 ; `GetExeHameFromWindowsW'::`2'::rachrModuleNameBuffer
;	COMDAT .pdata
.pdata	SEGMENT
|$pdata1$GetExeHameFromWindowsW| DCD imagerel |GetExeHameFromWindowsW|
	DCD	imagerel |$unwind2$GetExeHameFromWindowsW|
;	COMDAT .xdata
.xdata	SEGMENT
|$unwind2$GetExeHameFromWindowsW| DCD 0x32a0001c
	DCD	0xa8fb02
	DCD	0xa802ff
	DCD	0xff
;	COMDAT .pdata
...
; File f:\source_code\visual_studio\projects\native\dll\nativeconsoleappaids\nativeconssoleappaids\getexenamefromwindowsw.c
;	COMDAT GetExeHameFromWindowsW
.text$mn	SEGMENT

|GetExeHameFromWindowsW| PROC
...
; 18   : {
	...
	sub         sp,sp,#8
|$M10|
	ldr         r0,|$LN9@GetExeHame|		; =|__52D30485_getexenamefromwindowsw@c|
...
; 21   : 	if ( GetModuleFileName ( NULL ,												// HMODULE hModule:		A handle to the loaded module whose path is being requested. If this parameter is NULL, GetModuleFileName retrieves the path of the executable file of the current process.
	...
	mov         r2,#0x104
	ldr         r1,|$LN7@GetExeHame|		; =|?rachrModuleNameBuffer@?1??GetExeHameFromWindowsW@@9@9|
	movs        r0,#0
	ldr         r3,|$LN8@GetExeHame|		; =|__imp_GetModuleFileNameW|
	ldr         r3,[r3]
	blx         r3
	str         r0,[sp,#4]
	ldr         r3,[sp,#4]
...
; 25   : 		return ( LPTSTR ) &rachrModuleNameBuffer;
	...
	ldr         r3,|$LN7@GetExeHame|		; =|?rachrModuleNameBuffer@?1??GetExeHameFromWindowsW@@9@9|
	str         r3,[sp]
	b           |$LN1@GetExeHame|
...
|$LN6@GetExeHame|
|$LN7@GetExeHame|
	DCD         |?rachrModuleNameBuffer@?1??GetExeHameFromWindowsW@@9@9|
|$LN8@GetExeHame|
	DCD         |__imp_GetModuleFileNameW|
|$LN9@GetExeHame|
	DCD         |__52D30485_getexenamefromwindowsw@c|
|$M11|

	ENDP  ; |GetExeHameFromWindowsW|
