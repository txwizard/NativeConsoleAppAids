//	============================================================================
//  GetANSIStringPointer.c: Get a pointer to a null terminated resource string.
//	============================================================================
...
{
	LPTSTR lpTheString = AllocCString_WW ( RCDATA_MAX_LENGTH_P6C );
	...
	{	// The documented return value of LoadString excludes the trailing null. However, when nBufferMax = RCDATA_INPLACE_POINTER, it is included.
		if ( *plpuintLength = ( LoadString ( phSourceModule ,					// _in_     HMODULE   hModule
									         ...
									         lpTheString ,						// _Out_    LPTSTR    lpBuffer
										     RCDATA_MAX_LENGTH_P6C ) ) )		// _In_     int       nBufferMax
	...
	ReportLoadStringError ( phSourceModule ,
	                        puintStringID ,
